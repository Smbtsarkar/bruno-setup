...
## 26. Enforcement layer (settings.json + hooks)
...
The rules in §17–26 were derived from the Citadel v1.0.0 → v1.0.8 release cycle, where five operator-discovered bugs shipped because the original framework lacked these protections. See `docs/LEARNINGS.md` in any project for the full retrospective; the contracts here are the structural fixes.
