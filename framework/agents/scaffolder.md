...
- `docs/REQUIREMENTS.md` for token substitutions (summary, license, declared integrations, etc.) — produced by main agent's requirements interview and approved by the operator before main agent invoked you.
